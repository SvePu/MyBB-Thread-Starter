...
$l['setting_threadstarter_text_desc'] = "Enter the text you want. (no html allowed!)";
$l['setting_threadstarter_image'] = "Path to thread starter image.";
$l['setting_threadstarter_image_desc'] = "If you want show an image for thread starter, enter the path to that image here. Use <strong>{theme}</strong> to specify the image directory for the viewers current theme.";
